...
Copy and paste the ['jenkins_pipeline.groovy'](https://github.com/d-priyankamani/patch-precheck-ci/blob/master/jenkins/pipeline.groovy) code into the Jenkins Groovy script console.
